...
from my_tool_registry import MyToolRegistry
...
class MyToolChain:
    ...
    def execute(self, registry: MyToolRegistry, initial_input: str, context: Dict[str, Any] = None) -> str:
        """执行工具链"""
        context = context or {}
...
class ToolChainManager:
    ...
    def __init__(self, registry: MyToolRegistry):
        self.registry = registry
        self.chains: Dict[str, MyToolChain] = {}

    def register_chain(self, chain: MyToolChain):
        """注册工具链"""
...
# 使用示例
def create_research_chain() -> MyToolChain:
    """创建一个研究工具链:搜索 -> 计算 -> 总结"""
    chain = MyToolChain(
